...
final List<RouteBase> propertyRoutes = [
  ...
  // 2. Property Details (Public/Seller view of a specific property)
  GoRoute(
    path: '/property/:id',
  ...
  // Sub-route for reviewing a specific bid (Made top-level to match current UI routing)
  GoRoute(
