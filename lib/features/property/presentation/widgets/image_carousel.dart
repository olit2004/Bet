...
class ImageCarousel extends StatefulWidget {
  ...
  final bool isOverlapStyle; // Added to support both styles
  ...
  Widget build(BuildContext context) {
    ...
    return Stack(
      children: [
        ...
        if (widget.isOverlapStyle) ...[
          // Photo Count Badge (New Style)
          if (widget.imageUrls.isNotEmpty)
            Positioned(
              ...
              child: Container(
                ...
                child: Text(
                  '${_currentPage + 1} / ${widget.imageUrls.length} PHOTOS',
          ...
          // Standard Style (Dot Indicator and Overlay Buttons)
          ...
          // Back Button Overlay (Standard Style)
          Positioned(
            top: MediaQuery.of(context).padding.top + 10,
            left: 16,
            child: CircleAvatar(
