              ...
              Container(
                ...
                child: ClipRRect(
                  ...
                  child: Image.asset(
                    ...
                    fit: BoxFit.cover,
                    width: double.infinity,
                    errorBuilder: (_, _, _) => const Center(child: Icon(Icons.home, color: Colors.white)),
                  ),
                ),
              ),
              Positioned(
              ...
              children: [
                ClipRRect(
                  ...
                  child: Image.asset(
                    ...
                    width: double.infinity,
                    height: double.infinity,
                    errorBuilder: (_, _, _) => const Center(child: Icon(Icons.chair_alt, size: 40, color: Colors.white)),
                  ),
                ),
                Container(
                  decoration: BoxDecoration(
              ...
              Container(
                ...
                child: ClipRRect(
                  ...
                  child: Image.asset(
                    ...
                    fit: BoxFit.cover,
                    width: double.infinity,
                    errorBuilder: (_, _, _) => const Center(child: Icon(Icons.home_work, color: Colors.white)),
                  ),
                ),
              ),
              Positioned(
